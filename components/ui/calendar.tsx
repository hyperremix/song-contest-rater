  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-primary-500 text-zinc-50 hover:bg-primary-500 hover:text-zinc-50 focus:bg-primary-500 focus:text-zinc-50  dark:text-zinc-900 dark:hover:text-zinc-900 dark:focus:text-zinc-900 hover:dark:bg-primary-500 focus:dark:bg-primary-500',
        day_today: 'bg-zinc-200 text-primary-500 dark:bg-zinc-800',
        day_outside:
